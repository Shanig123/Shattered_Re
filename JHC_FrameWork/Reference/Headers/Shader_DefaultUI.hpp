...
PS_OUT			PS_MAIN_No_Alpha(PS_IN In)
{
	PS_OUT		Out = (PS_OUT)0;
...
technique Default_Device
{
		...
		pass	NoAlpha2	// 19
	{
		...
		VertexShader = compile vs_3_0 VS_MAIN();
		PixelShader = compile ps_3_0 PS_MAIN_No_Alpha();
	}
		pass AlphaBlendOption1_NoAlpha2	// 20
	{
		alphablendenable = true;
		...
		pass AlphaBlendOption2_NoAlpha2	// 21
	{
		alphablendenable = true;
		...
		pass AlphaBlendOption3_NoAlpha2	// 22
	{
		alphablendenable = true;
		srcblend = one;
		destblend = one;
