...
PS_OUT			PS_MAIN_TOTAL(PS_INOren In)
{
	...
	//Out Specular
	//Out.vDepth.g = pow(abs(length(vSpecular.xyz)),2.2);
	Out.vDepth.y = length(vSpecular.xyz);
...
PS_OUT	PS_MAIN_NO_BUMP_NPC(PS_INOren In)
{
	PS_OUT		Out = (PS_OUT)0;
	Out = PS_MAIN_NO(In);
...
PS_OUT	PS_MAIN_TOTAL_NPC(PS_INOren In)
{
	PS_OUT		Out = (PS_OUT)0;
	Out = PS_MAIN_NO(In);
...
PS_OUT	PS_MAIN_ONLY_BUMP_NPC(PS_INOren In)
{
	PS_OUT		Out = (PS_OUT)0;
	Out = PS_MAIN_BUMP(In);
...
technique Default_Device
{
	...
	PixelShader = compile ps_3_0 PS_MAIN_BUMP_DISSOLVE_RE();
		...
		pass    NON_______//12//	pass DissolveRe
	{
		cullmode = none;
		alphablendenable = true;
		srcblend = srcalpha;
		...
		pass  Static_TOTAL_BUMP_NPC		//13//pass NPC_
	{
		alphablendenable = true;
		srcblend = srcalpha;
		destblend = invsrcalpha;
		...
		VertexShader = compile vs_3_0 VS_MAINOren();
		PixelShader = compile ps_3_0 PS_MAIN_TOTAL_NPC();
	}
		pass  Static_NO_BUMP_NPC		//14//	pass NPC_
	{
		alphablendenable = true;
		srcblend = srcalpha;
		destblend = invsrcalpha;
		...
		VertexShader = compile vs_3_0 VS_MAINOren();
		PixelShader = compile ps_3_0 PS_MAIN_NO_BUMP_NPC();
	}

		pass  Static_ONLY_BUMP_NPC		//15//	pass NPC_
	{
		alphablendenable = true;
		srcblend = srcalpha;
		destblend = invsrcalpha;
		...
		VertexShader = compile vs_3_0 VS_MAINOren();
		PixelShader = compile ps_3_0 PS_MAIN_ONLY_BUMP_NPC();
	}
};
