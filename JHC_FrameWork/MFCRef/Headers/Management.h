...
public: /* For.Particle_Manager */
	HRESULT Generate_Particle(const _uint& _iSceneIdx,
		...
		ePartilcePatternType _eParticleMovePattern,
	...
	HRESULT Generate_Decal(const _uint& _iSceneIdx,
		...
		_uint _iTextureDrawId = 0,
		ePartilcePatternType _eParticleMovePattern = (ePartilcePatternType)((_uint)ePartilcePatternType::OnStartBlinkPow | (_uint)ePartilcePatternType::GoStraight | (_uint)ePartilcePatternType::ScaleUp | (_uint)ePartilcePatternType::x3),
...
public:	/* For.Sound_Manager*/
	...
	void Play3DSounds(const wstring& _wstSoundKey, CSound_Manager::ESoundID _eType, _float3 _vSpeakerPos, _float _fMin, _float _fMax, _float _fVolume = 1.f);
