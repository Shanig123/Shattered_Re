...
CMap_Stage2Area8::CMap_Stage2Area8(_DEVICE _pDevice)
...
CMap_Stage2Area8::CMap_Stage2Area8(const CMap_Stage2Area8 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area8::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area8::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area8::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area8::Render_GameObject()
{
...
HRESULT CMap_Stage2Area8::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area8House:
			wstrMapType = to_wstring(i) + L"_Area8House";
			break;
		case EMapType::Area8Crate:
			wstrMapType = to_wstring(i) + L"_Area8Crate";
			break;
		case EMapType::Area8Meteor:
			wstrMapType = to_wstring(i) + L"_Area8Meteor";
			break;
		}
...
HRESULT CMap_Stage2Area8::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area8::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area8House:
			wstrMapType = L"_Area8House";
			break;
		case EMapType::Area8Crate:
			wstrMapType = L"_Area8Crate";
			break;
		case EMapType::Area8Meteor:
			wstrMapType = L"_Area8Meteor";
			break;
		}
...
void CMap_Stage2Area8::Add_RenderList()
{
...
CMap_Stage2Area8 * CMap_Stage2Area8::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area8* pInstance = new CMap_Stage2Area8(_pDevice);
...
CGameObject * CMap_Stage2Area8::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area8* pClone = new CMap_Stage2Area8(*this);
