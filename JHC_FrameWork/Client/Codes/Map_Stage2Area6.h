...
#ifndef __MAP_STAGE2AREA6_H__
#define __MAP_STAGE2AREA6_H__

#include "GameObject.h"

USING(Engine)

class CMap_Stage2Area6 final : public CGameObject
{
private:
	enum EMapType
	{
...
private:
	explicit CMap_Stage2Area6(_DEVICE _pDevice);
	explicit CMap_Stage2Area6(const CMap_Stage2Area6& _rOther);
	virtual ~CMap_Stage2Area6() = default;
...
public:
	static CMap_Stage2Area6* Create(_DEVICE _pDevice);
