...
#ifndef __MAP_STAGE2Trap_H__
#define __MAP_STAGE2Trap_H__

#include "GameObject.h"

USING(Engine)

class CMap_Stage2Trap final : public CGameObject
{
private:
	enum EMapType
	{
...
private:
	explicit CMap_Stage2Trap(_DEVICE _pDevice);
	explicit CMap_Stage2Trap(const CMap_Stage2Trap& _rOther);
	virtual ~CMap_Stage2Trap() = default;
...
public:
	static CMap_Stage2Trap* Create(_DEVICE _pDevice);
