...
CMap_Stage2Area2::CMap_Stage2Area2(_DEVICE _pDevice)
...
CMap_Stage2Area2::CMap_Stage2Area2(const CMap_Stage2Area2 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area2::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area2::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area2::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area2::Render_GameObject()
{
...
HRESULT CMap_Stage2Area2::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area2Fence:
			wstrMapType = to_wstring(i) + L"_Area2Fence";
			break;
		case EMapType::Area2Climb:
			wstrMapType = to_wstring(i) + L"_Area2Climb";
			break;
		}
...
HRESULT CMap_Stage2Area2::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area2::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area2Fence:
			wstrMapType = L"_Area2Fence";
			break;
		case EMapType::Area2Climb:
			wstrMapType = L"_Area2Climb";
			break;
		}
...
void CMap_Stage2Area2::Add_RenderList()
{
...
CMap_Stage2Area2 * CMap_Stage2Area2::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area2* pInstance = new CMap_Stage2Area2(_pDevice);
...
CGameObject * CMap_Stage2Area2::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area2* pClone = new CMap_Stage2Area2(*this);
