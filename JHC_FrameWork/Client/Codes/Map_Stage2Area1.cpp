...
CMap_Stage2Area1::CMap_Stage2Area1(_DEVICE _pDevice)
...
CMap_Stage2Area1::CMap_Stage2Area1(const CMap_Stage2Area1 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area1::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area1::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area1::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area1::Render_GameObject()
{
...
HRESULT CMap_Stage2Area1::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area1House:
			wstrMapType = to_wstring(i) + L"_Area1House";
			break;
		case EMapType::Area1Fence:
			wstrMapType = to_wstring(i) + L"_Area1Fence";
			break;
		case EMapType::Area1BigHouse:
			wstrMapType = to_wstring(i) + L"_Area1BigHouse";
			break;
		case EMapType::Area1SmallHouse:
			wstrMapType = to_wstring(i) + L"_Area1SmallHouse";
			break;
		case EMapType::Area1Wall:
			wstrMapType = to_wstring(i) + L"_Area1Wall";
			break;
		case EMapType::Area1Crate:
			wstrMapType = to_wstring(i) + L"_Area1Crate";
			break;
		}
...
HRESULT CMap_Stage2Area1::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area1::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area1House:
			wstrMapType = L"_Area1House";
			break;
		case EMapType::Area1Fence:
			wstrMapType = L"_Area1Fence";
			break;
		case EMapType::Area1BigHouse:
			wstrMapType = L"_Area1BigHouse";
			break;
		case EMapType::Area1SmallHouse:
			wstrMapType = L"_Area1SmallHouse";
			break;
		case EMapType::Area1Wall:
			wstrMapType = L"_Area1Wall";
			break;
		case EMapType::Area1Crate:
			wstrMapType = L"_Area1Crate";
			break;
		}
...
void CMap_Stage2Area1::Add_RenderList()
{
...
CMap_Stage2Area1 * CMap_Stage2Area1::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area1* pInstance = new CMap_Stage2Area1(_pDevice);
...
CGameObject * CMap_Stage2Area1::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area1* pClone = new CMap_Stage2Area1(*this);
