...
#ifndef __CHESSPIECE_QUEEN_H__
#define __CHESSPIECE_QUEEN_H__

#include "GameObject.h"

USING(Engine)

class CChessPiece_Queen final : public CGameObject
{
private:
...
private:
	explicit CChessPiece_Queen(_DEVICE _pDevice, const wstring& _PrototypeName);
	explicit CChessPiece_Queen(const CChessPiece_Queen& _rOther);
	virtual ~CChessPiece_Queen() = default;
...
public:
	...
	void Set_ChangeRimLight(_uint _iPass, _float3& _Color = _float3(0.f, 0.f, 0.f));

public:
	static CChessPiece_Queen* Create(_DEVICE _pDevice, const wstring& _PrototypeName);
