...
#ifndef __MAP_STAGE2AREA2_H__
#define __MAP_STAGE2AREA2_H__

#include "GameObject.h"

USING(Engine)

class CMap_Stage2Area2 final : public CGameObject
{
private:
	enum EMapType
	{
...
private:
	explicit CMap_Stage2Area2(_DEVICE _pDevice);
	explicit CMap_Stage2Area2(const CMap_Stage2Area2& _rOther);
	virtual ~CMap_Stage2Area2() = default;
...
public:
	static CMap_Stage2Area2* Create(_DEVICE _pDevice);
