...
CLoading_Circle_Min::CLoading_Circle_Min(_DEVICE _pDevice)
	: CUIBase(_pDevice), m_bCheckFadeIn(false), m_bCheckInit(false)
{
}

CLoading_Circle_Min::CLoading_Circle_Min(const CLoading_Circle_Min & _rOther)
	: CUIBase(_rOther), m_bCheckFadeIn(false), m_bCheckInit(false)
{
}

HRESULT CLoading_Circle_Min::Ready_GameObject_Prototype()
{
...
HRESULT CLoading_Circle_Min::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg/* = nullptr*/)
{
...
_uint CLoading_Circle_Min::Update_GameObject(const _float & _fDeltaTime)
{
	...
	m_pTransform->Rotate(EAxis::Z, D3DXToRadian(5.f), -1.f, _fDeltaTime);

	m_pTransform->Update_Transform();
	return (_uint)EEvent::None;
}

HRESULT CLoading_Circle_Min::Render_GameObject()
{
...
void CLoading_Circle_Min::DissolveControl(const _float & _fDeltaTime)
{
...
CLoading_Circle_Min * CLoading_Circle_Min::Create(_DEVICE _pDevice)
{
	CLoading_Circle_Min* pInstance = new CLoading_Circle_Min(_pDevice);
...
CGameObject * CLoading_Circle_Min::Clone(const _uint& _iSceneIdx, void * _pArg /*= nullptr*/)
{
	CLoading_Circle_Min* pClone = new CLoading_Circle_Min(*this);
