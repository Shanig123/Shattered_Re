...
CMap_Stage2Area4::CMap_Stage2Area4(_DEVICE _pDevice)
...
CMap_Stage2Area4::CMap_Stage2Area4(const CMap_Stage2Area4 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area4::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area4::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area4::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area4::Render_GameObject()
{
...
HRESULT CMap_Stage2Area4::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area4Fence:
			wstrMapType = to_wstring(i) + L"_Area4Fence";
			break;
		case EMapType::Area4House:
			wstrMapType = to_wstring(i) + L"_Area4House";
			break;
		}
...
HRESULT CMap_Stage2Area4::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area4::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area4Fence:
			wstrMapType = L"_Area4Fence";
			break;
		case EMapType::Area4House:
			wstrMapType = L"_Area4House";
			break;
		}
...
void CMap_Stage2Area4::Add_RenderList()
{
...
CMap_Stage2Area4 * CMap_Stage2Area4::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area4* pInstance = new CMap_Stage2Area4(_pDevice);
...
CGameObject * CMap_Stage2Area4::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area4* pClone = new CMap_Stage2Area4(*this);
