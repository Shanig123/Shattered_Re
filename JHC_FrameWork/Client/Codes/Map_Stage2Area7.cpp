...
CMap_Stage2Area7::CMap_Stage2Area7(_DEVICE _pDevice)
...
CMap_Stage2Area7::CMap_Stage2Area7(const CMap_Stage2Area7 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area7::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area7::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area7::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area7::Render_GameObject()
{
...
HRESULT CMap_Stage2Area7::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area7Meteor:
			wstrMapType = to_wstring(i) + L"_Area7Meteor";
			break;
		case EMapType::Area7Fence:
			wstrMapType = to_wstring(i) + L"_Area7Fence";
			break;
		case EMapType::Area7ShrineFloor:
			wstrMapType = to_wstring(i) + L"_Area7ShrineFloor";
			break;
		case EMapType::Area7ShrineMetal:
			wstrMapType = to_wstring(i) + L"_Area7ShrineMetal";
			break;
		case EMapType::Area7ShrineWhite:
			wstrMapType = to_wstring(i) + L"_Area7ShrineWhite";
			break;
		case EMapType::Area7ShrineWood:
			wstrMapType = to_wstring(i) + L"_Area7ShrineWood";
			break;
		}
...
HRESULT CMap_Stage2Area7::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area7::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area7Meteor:
			wstrMapType = L"_Area7Meteor";
			break;
		case EMapType::Area7Fence:
			wstrMapType = L"_Area7Fence";
			break;
		case EMapType::Area7ShrineFloor:
			wstrMapType = L"_Area7ShrineFloor";
			break;
		case EMapType::Area7ShrineMetal:
			wstrMapType = L"_Area7ShrineMetal";
			break;
		case EMapType::Area7ShrineWhite:
			wstrMapType = L"_Area7ShrineWhite";
			break;
		case EMapType::Area7ShrineWood:
			wstrMapType = L"_Area7ShrineWood";
			break;
		}
...
void CMap_Stage2Area7::Add_RenderList()
{
...
CMap_Stage2Area7 * CMap_Stage2Area7::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area7* pInstance = new CMap_Stage2Area7(_pDevice);
...
CGameObject * CMap_Stage2Area7::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area7* pClone = new CMap_Stage2Area7(*this);
