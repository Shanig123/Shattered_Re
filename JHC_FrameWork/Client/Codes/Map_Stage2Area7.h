...
#ifndef __MAP_STAGE2AREA7_H__
#define __MAP_STAGE2AREA7_H__

#include "GameObject.h"

USING(Engine)

class CMap_Stage2Area7 final : public CGameObject
{
private:
	enum EMapType
	{
...
private:
	explicit CMap_Stage2Area7(_DEVICE _pDevice);
	explicit CMap_Stage2Area7(const CMap_Stage2Area7& _rOther);
	virtual ~CMap_Stage2Area7() = default;
...
public:
	static CMap_Stage2Area7* Create(_DEVICE _pDevice);
