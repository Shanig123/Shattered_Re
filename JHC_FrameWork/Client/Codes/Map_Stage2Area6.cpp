...
CMap_Stage2Area6::CMap_Stage2Area6(_DEVICE _pDevice)
...
CMap_Stage2Area6::CMap_Stage2Area6(const CMap_Stage2Area6 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area6::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area6::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area6::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area6::Render_GameObject()
{
...
HRESULT CMap_Stage2Area6::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area6Fence:
			wstrMapType = to_wstring(i) + L"_Area6Fence";
			break;
		case EMapType::Area6Wall:
			wstrMapType = to_wstring(i) + L"_Area6Wall";
			break;
		case EMapType::Area6SmallWall:
			wstrMapType = to_wstring(i) + L"_Area6SmallWall";
			break;
		case EMapType::Area6House:
			wstrMapType = to_wstring(i) + L"_Area6House";
			break;
		case EMapType::Area6Stair:
			wstrMapType = to_wstring(i) + L"_Area6Stair";
			break;
		}
...
HRESULT CMap_Stage2Area6::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area6::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area6Fence:
			wstrMapType = L"_Area6Fence";
			break;
		case EMapType::Area6Wall:
			wstrMapType = L"_Area6Wall";
			break;
		case EMapType::Area6SmallWall:
			wstrMapType = L"_Area6SmallWall";
			break;
		case EMapType::Area6House:
			wstrMapType = L"_Area6House";
			break;
		case EMapType::Area6Stair:
			wstrMapType = L"_Area6Stair";
			break;
		}
...
void CMap_Stage2Area6::Add_RenderList()
{
...
CMap_Stage2Area6 * CMap_Stage2Area6::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area6* pInstance = new CMap_Stage2Area6(_pDevice);
...
CGameObject * CMap_Stage2Area6::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area6* pClone = new CMap_Stage2Area6(*this);
