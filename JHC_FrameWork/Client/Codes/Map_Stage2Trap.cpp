...
CMap_Stage2Trap::CMap_Stage2Trap(_DEVICE _pDevice)
...
CMap_Stage2Trap::CMap_Stage2Trap(const CMap_Stage2Trap & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Trap::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Trap::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Trap::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Trap::Render_GameObject()
{
...
HRESULT CMap_Stage2Trap::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::TrapSpike:
			wstrMapType = to_wstring(i) + L"_TrapSpike";
			break;
		}
...
HRESULT CMap_Stage2Trap::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Trap::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
...
void CMap_Stage2Trap::Add_RenderList()
{
...
CMap_Stage2Trap * CMap_Stage2Trap::Create(_DEVICE _pDevice)
{
	CMap_Stage2Trap* pInstance = new CMap_Stage2Trap(_pDevice);
...
CGameObject * CMap_Stage2Trap::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Trap* pClone = new CMap_Stage2Trap(*this);
