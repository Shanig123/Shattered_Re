#pragma once
#ifndef __UI_NPC_CHORON_H__
#define __UI_NPC_CHORON_H__

#include "UIBase.h"

USING(Engine)

class CUI_NPC_Choron : public CUIBase
{
private:
	enum class eUIMode
	{
...
protected:
	explicit CUI_NPC_Choron(_DEVICE _pDevice);
	explicit CUI_NPC_Choron(const CUI_NPC_Choron& _rhs);
	virtual ~CUI_NPC_Choron() = default;
...
public:
	static CUI_NPC_Choron* Create(_DEVICE _pDevice);
	virtual CGameObject * Clone(const _uint & _iSceneIdx, void * _pArg = nullptr) override;

};

#endif // !__UI_NPC_CHORON_H__
