...
CMap_Stage2Area5::CMap_Stage2Area5(_DEVICE _pDevice)
...
CMap_Stage2Area5::CMap_Stage2Area5(const CMap_Stage2Area5 & _rOther)
	: CGameObject(_rOther)
{
}

HRESULT CMap_Stage2Area5::Ready_GameObject_Prototype()
{
...
HRESULT CMap_Stage2Area5::Ready_GameObject_Clone(const _uint& _iSceneIdx, void * _pArg)
{
...
_uint CMap_Stage2Area5::Update_GameObject(const _float & _fDeltaTime)
{
...
HRESULT CMap_Stage2Area5::Render_GameObject()
{
...
HRESULT CMap_Stage2Area5::Add_Component()
{
	/* For.Com_DynamicMesh */
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		switch (i)
		{
		case EMapType::Area5Fence:
			wstrMapType = to_wstring(i) + L"_Area5Fence";
			break;
		case EMapType::Area5House:
			wstrMapType = to_wstring(i) + L"_Area5House";
			break;
		case EMapType::Area5SmallHouse:
			wstrMapType = to_wstring(i) + L"_Area5SmallHouse";
			break;
		case EMapType::Area5BigHouse:
			wstrMapType = to_wstring(i) + L"_Area5BigHouse";
			break;
		case EMapType::Area5Meteor:
			wstrMapType = to_wstring(i) + L"_Area5Meteor";
			break;
		case EMapType::Area5Crate:
			wstrMapType = to_wstring(i) + L"_Area5Crate";
			break;
		}
...
HRESULT CMap_Stage2Area5::SetUp_ConstantTable(_EFFECT _pEffect)
{
...
HRESULT CMap_Stage2Area5::Ready_MapCollider()
{
	auto pManagement = GET_MANAGEMENT;
	...
	for (_uint i = 0; i < EMapType::End; ++i)
	{
		...
		{
		case EMapType::Area5Fence:
			wstrMapType = L"_Area5Fence";
			break;
		case EMapType::Area5House:
			wstrMapType = L"_Area5House";
			break;
		case EMapType::Area5SmallHouse:
			wstrMapType = L"_Area5SmallHouse";
			break;
		case EMapType::Area5BigHouse:
			wstrMapType = L"_Area5BigHouse";
			break;
		case EMapType::Area5Meteor:
			wstrMapType = L"_Area5Meteor";
			break;
		case EMapType::Area5Crate:
			wstrMapType = L"_Area5Crate";
			break;
		}
...
void CMap_Stage2Area5::Add_RenderList()
{
...
CMap_Stage2Area5 * CMap_Stage2Area5::Create(_DEVICE _pDevice)
{
	CMap_Stage2Area5* pInstance = new CMap_Stage2Area5(_pDevice);
...
CGameObject * CMap_Stage2Area5::Clone(const _uint& _iSceneIdx, void * _pArg)
{
	CMap_Stage2Area5* pClone = new CMap_Stage2Area5(*this);
